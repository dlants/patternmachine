	...
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['%'],
				val,
				_elm_lang$core$Array$length(_dlants$patternmachine$Grid$colors)),
			_dlants$patternmachine$Grid$colors));
};
var _dlants$patternmachine$Grid$boxStyle = F2(
	function (val, size) {
		var sizeStr = A2(
			_elm_lang$core$Basics_ops['++'],
		...
		return _elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'width', _1: sizeStr},
					{ctor: '_Tuple2', _0: 'height', _1: sizeStr},
					{ctor: '_Tuple2', _0: 'margin', _1: '1px'},
					{
					ctor: '_Tuple2',
					_0: 'background-color',
					_1: _dlants$patternmachine$Grid$getColor(val)
				}
				]));
	});
...
var _dlants$patternmachine$Grid$boxsize = function (model) {
	var _p1 = model.matrix.size;
	var cols = _p1._0;
	var rows = _p1._1;
	return A2(_elm_lang$core$Basics$min, (model.window.width / cols) | 0, (model.window.height / rows) | 0);
};
var _dlants$patternmachine$Grid$matrixRows = function (matrix) {
	return A2(
...
var _dlants$patternmachine$Grid$init = function (windowSize) {
	return {
		matrix: A3(_eeue56$elm_flat_matrix$Matrix$repeat, 10, 10, 0),
		window: windowSize
	};
};
var _dlants$patternmachine$Grid$Model = F2(
	function (a, b) {
		return {matrix: a, window: b};
	});
var _dlants$patternmachine$Grid$Increment = F2(
	function (a, b) {
		return {ctor: 'Increment', _0: a, _1: b};
	});
var _dlants$patternmachine$Grid$drawBox = F4(
	function (size, rowidx, colidx, val) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					A2(_dlants$patternmachine$Grid$Increment, rowidx, colidx)),
					A2(_dlants$patternmachine$Grid$boxStyle, val, size)
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _dlants$patternmachine$Grid$drawRow = F3(
	function (size, rowidx, row) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Array$toList(
				A2(
					...
					A2(_dlants$patternmachine$Grid$drawBox, size, rowidx),
					row)));
	});
var _dlants$patternmachine$Grid$view = function (model) {
	var size = _dlants$patternmachine$Grid$boxsize(model);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'background-color',
						_1: _dlants$patternmachine$Grid$getColor(0)
					}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
...
var _dlants$patternmachine$Grid$NoOp = {ctor: 'NoOp'};
...
var _dlants$patternmachine$PatternMachine$view = function (model) {
	return A2(
		_elm_lang$html$Html_App$map,
		_dlants$patternmachine$PatternMachine$GridMsg,
		_dlants$patternmachine$Grid$view(model));
};
var _dlants$patternmachine$PatternMachine$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _dlants$patternmachine$PatternMachine$onSuccess = function (size) {
	return _dlants$patternmachine$PatternMachine$Resize(size);
};
var _dlants$patternmachine$PatternMachine$subscriptions = function (model) {
	return _elm_lang$window$Window$resizes(_dlants$patternmachine$PatternMachine$Resize);
};
var _dlants$patternmachine$PatternMachine$NoOp = {ctor: 'NoOp'};
var _dlants$patternmachine$PatternMachine$onError = function (x) {
...
var _dlants$patternmachine$PatternMachine$init = function (result) {
	var model = function () {
		...
		if (_p5.ctor === 'Ok') {
			...
			return {
				matrix: A3(_eeue56$elm_flat_matrix$Matrix$repeat, 10, 10, 1),
				window: {width: 100, height: 100}
			};
		}
	}();
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['PatternMachine'], 'PatternMachine', typeof _dlants$patternmachine$PatternMachine$main === 'undefined' ? null : _dlants$patternmachine$PatternMachine$main);
